...
den_mat_fe = ylp.forwardEulerLvn(H, rho0, h, final_time)
den_mat_be = ylp.backwardEulerLvn(H,rho0,h,final_time)
den_mat_tr = ylp.trapezoidalRuleLvn(H, rho0, h, final_time)

actual_values = ylp.traceInnerProduct(den_mat_actual, qt.sigmax())/2
fe_values = ylp.traceInnerProduct(den_mat_fe, qt.sigmax())/2
be_values = ylp.traceInnerProduct(den_mat_be, qt.sigmax())/2
tr_values = ylp.traceInnerProduct(den_mat_tr, qt.sigmax())/2
